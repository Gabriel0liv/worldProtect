...
public final class AddRegionSubjectRequest {
    private final RegionId regionId;
    private final RegionRole role;
    private final SubjectRefConfig subject;

    private AddRegionSubjectRequest(RegionId regionId, RegionRole role, SubjectRefConfig subject) {
        this.regionId = Objects.requireNonNull(regionId, "regionId must not be null");
        this.role = Objects.requireNonNull(role, "role must not be null");
        this.subject = Objects.requireNonNull(subject, "subject must not be null");
    }

    public static AddRegionSubjectRequest of(RegionId regionId, RegionRole role, SubjectRefConfig subject) {
        return new AddRegionSubjectRequest(regionId, role, subject);
    }
